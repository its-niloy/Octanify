...
if not addon_utils.check("octane")[1]:
    # Octane reads its AddonPreferences during register(), so it needs the
    # in-memory preferences entry created by default_set. The background
    # validator never saves user preferences.
